...
<section class="home">
    ...
    <div class="swiper home-slider">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide slide" style="background:url(images/header1-2.jpg) no-repeat">
                <div class="content">
                    <span>safety & easy to use</span>
                    <h3>indonesian boarding house website</h3>
                    <a href="package.php" class="btn">discover</a>
            ...
            <div class="swiper-slide slide" style="background:url(images/header1-4.jpg) no-repeat">
                <div class="content">
                    <span>safety & easy to use</span>
                    <h3>indonesian boarding house website</h3>
                    <a href="package.php" class="btn">discover</a>
...
<section class="home-about">
    ...
    <div class="content">
        <h3>about us</h3>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eum neque suscipit accusamus, reiciendis voluptate, dolorem cum consectetur eaque et corrupti quibusdam delectus molestiae aut hic eligendi minima quasi, sint repellendus?</p>
...
<section class="home-offer">
    <div class="content">
        <h3>up to 20% off!</h3>
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Impedit assumenda molestias, quis velit ea excepturi! Totam, nostrum? Explicabo cum tenetur, cumque, quaerat eius deserunt voluptatibus assumenda odit a aliquam quos.</p>
        <a href="book.php" class="btn">book now</a>
    </div>
</section>
